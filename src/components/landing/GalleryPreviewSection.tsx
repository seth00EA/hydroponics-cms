                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {preview.map((item, index) => (
                        <Link
                            key={item.id}
                            href="/gallery"
                            className={`group relative overflow-hidden rounded-2xl border border-card-border bg-card shadow-sm transition-all hover:shadow-lg ${index === 0 ? "sm:col-span-2 lg:col-span-2" : ""
                                }`}
                        >
                            <div
                                className={`relative bg-primary-light ${index === 0
